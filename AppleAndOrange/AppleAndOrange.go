 ...
 */
func countFruit(hStart, hEnd, fruitTreeLocation int32, fruitDistances []int32) int32 {
	var fruits int32
	for _, e := range fruitDistances {
		if inInterval(hStart, hEnd, (fruitTreeLocation + e)) {
			fruits++
		}
	}
	return fruits
...
func inInterval(a, b, c int32) bool {
	if c >= a && c <= b {
		return true
	}
	return false
...
func countApplesAndOranges(s int32, t int32, a int32, b int32, apples []int32, oranges []int32) {
	...
	fmt.Println(countFruit(s, t, a, apples))
	fmt.Println(countFruit(s, t, b, oranges))
